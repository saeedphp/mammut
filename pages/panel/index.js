...
/*export default function Home() {
    return (
        ...
        ضریب انتقال دمای یك ساندویچ پانل به ضخامت 5 سانتی‌متر به علت ضریب انتقال
        حرارتی فوق‌العاده پایین معادل یك دیوار آجری به ضخامت172 سانتی‌متر است كه
        ...
        خواهد شد."
          ...
          اشاره كرد:"
                ...
                p3="جذب رطوبت پایین و نفوذ ناپذیر در برابر برف، باران و گرد و خاك"
                p4=" مقاوم در برابر انوع مواد شیمیایی و قابلیت شستشو و بهداشتی بودن آن"
                more="دنیای ماموت با استفاده از پیشرفته‌ترین خطوط پیوسته و تمام اتوماتیك با
