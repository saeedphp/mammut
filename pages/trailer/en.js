...
const TrailerEn = () => {
    ...
    return (
        <div className="alternateHomePage homePage homeTrailer enPage">
            ...
            />
            <HomeImage
                title="Painting Process- Surface Preparation"
                imgPath="brake-system.jpg"
                description="One of the steps related to the Painting of the product is the shot Blasting process according to SA 2.5 / Epoxy sub-coat.
