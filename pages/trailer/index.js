  ...
  return (
    <div className="alternateHomePage homePage homeTrailer">
      ...
      />
        ...
        <HomeFeatured
            name="  طراحی محصول"
            features={["ابتدا برای توليد يك تريلر در دنيای ماموت طراحي محصول انجام می‌شود كه شامل امكان سنجی، طراحی مهندسی، تحقيق و توسعه و مهندسی فرآيندها می‌باشد."]}
            /*imgPath="lights.jpeg"*/
            direction="right"
            items={[
                "product-1.jpg",
        ...
        <HomeImage
            ...
            description="سيستم ترمز مورد استفاده در دنياي ماموت داراي قابليت‌هاي زير مي‌باشد:
