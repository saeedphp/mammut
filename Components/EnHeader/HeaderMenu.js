...
export default function HeaderMenu(props) {
  ...
  const menuItems = [
    { title: "Home", link: "/", sub: false, type: "" },
    { title: "About Us", link: "/" + prefix + "/about", sub: true, type: "about" },
    { title: " Products", link: "#", sub: true, type: "category" },
    ...
    { title: "Contact Us", link: prefix + "/#", sub: true, type: "contact" },
  ];
  if (prefix == "panel") {
